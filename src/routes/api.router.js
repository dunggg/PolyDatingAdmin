...
// 3. Friends
router.get("/friends/list-friends-requests/:email", friends.listFriendsRequests);
router.get("/friends/list-of-requests-sent/:email", friends.listOfRequestsSent);
router.get("/friends/list-friends/:email", friends.listFriends);
